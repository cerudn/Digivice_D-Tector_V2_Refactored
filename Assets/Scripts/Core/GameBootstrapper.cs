...
/// <summary>
/// Composition Root autom á—tico del juego.
...
public class GameBootstrapper
{
    ...
    private static void InitializeBeforeSceneLoad()
    {
        ...
        // A ñ—adir componentes en orden correcto
        ...
        // Inicializar GameManager (que inicializar á— el resto)
...
/// <summary>
/// Extensió·´·n para GameManager para permitir inicializació·´·n manual.
/// </summary>
public static partial class GameManagerExtensions
{
        ...
        IWorldManager worldManager)
    {
        ...
        // Usar reflexió·´·n o m é—todo p ú—blico para asignar dependencias

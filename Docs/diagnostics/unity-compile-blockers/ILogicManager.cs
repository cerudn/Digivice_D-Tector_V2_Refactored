...
/// <summary>
/// Interfaz para el gestor de lógica principal del juego.
/// Implementa el patrón State para manejar los diferentes estados del juego.
/// </summary>
public interface ILogicManager
{
    ...
    /// <summary>
    /// Inicializa el sistema de lógica.
    /// </summary>
    void Initialize();
